  ...
  return (
    ...
    >
      <div className="w-full px-4 py-6">
        ...
        {/* Game Showcase Section - FULL WIDTH VIDEO */}
              ...
              <div className="max-w-5xl mx-auto">
                {activeTab === 'pricing' && (
                  ...
                  >
                    ...
                    <div className="bg-gray-900 rounded-xl p-6 border-2 border-purple-500 hover:border-purple-400 transition-all relative">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-3xl font-bold text-white mb-4">$19<span className="text-lg">/mo</span></div>
                        <p className="text-gray-400 text-sm mb-6">For serious indie developers</p>
                        <ul className="text-left text-sm text-gray-400 space-y-2 mb-6">
                          <li>✓ Everything in Free</li>
                          <li>✓ Up to 5 game slots</li>
                          <li>✓ Custom domain</li>
                          <li>✓ Advanced analytics</li>
                          <li>✓ Priority support</li>
                          <li>✓ Custom CSS/themes</li>
                          <li>✓ Steam/Itch integration</li>
                        </ul>
                        <button className="w-full py-2 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-md transition-all">
                          Start Pro
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-900 rounded-xl p-6 border border-gray-800 hover:border-gray-600 transition-all">
                      <div className="text-center">
                        ...
                        <div className="text-3xl font-bold text-white mb-4">$49<span className="text-lg">/mo</span></div>
